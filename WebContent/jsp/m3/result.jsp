...
<img style="width: 300px; height: 250px; margin-left: 37%; border-radius: 20%" src="img/${food.img }">
<div style="margin-left:45.5%;">
<button id="button" style="font-size:15px;  width: 100px;height: 50px; margin-top: 30px;"
